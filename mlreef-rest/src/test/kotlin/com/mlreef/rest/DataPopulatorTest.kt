...
//    @Autowired private lateinit var accountTokenRepository: AccountTokenRepository
...
//    @Mock private lateinit var restClient: GitlabRestClient
    ...
    fun prepare() {
        ...
        author = personRepository.save(Person(id = randomUUID(), slug = "user-demo", name = "Author1"))
    }
