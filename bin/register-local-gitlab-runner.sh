...
# Debug log the configuration file to the console
...
OPTIONS:
   ...
   --tag-list value                                             Tag list (default: "docker") [$RUNNER_TAG_LIST]
   ...
   -r value, --registration-token value                         Runner's registration token (default: "ASuUZv_zgT5h6GFCvVsr") [$REGISTRATION_TOKEN]
   ...
   --access-level value                                         Set access_level of the runner to not_protected or ref_protected; defaults to not_protected (default: "not_protected") [$REGISTER_ACCESS_LEVEL]
   ...
   --name value, --description value                            Runner name (default: "local developer runner") [$RUNNER_NAME]
   ...
   -u value, --url value                                        Runner URL (default: "http://gitlab/") [$CI_SERVER_URL]
   ...
   --docker-image value                                         Docker image to be used (default: "alpine:latest") [$DOCKER_IMAGE]
   ...
   --docker-volumes value                                       Bind-mount a volume and create it if it doesn't exist prior to mounting. Can be specified multiple times once per mountpoint, e.g. --docker-volumes 'test0:/test0' --docker-volumes 'test1:/test1' (default: "[/var/run/docker.sock:/var/run/docker.sock]") [$DOCKER_VOLUMES]
