...
@parameter('images_path', "str", required=True, defaultValue='.')
@parameter('output_path', type="str", required=True, defaultValue='.')
@parameter('height', "int", True, defaultValue=256)
@parameter('width', "int", True, 256)
@parameter('epochs', "int", defaultValue=5, required=True)
@parameter('channels', required=False, defaultValue=3, type="int")
@parameter(required=False, defaultValue='False', name='use_pretrained', type="str", description="use pretrained?")
...
@parameter('learning_rate', required=False, defaultValue=.0001, type='float')
@parameter(name='loss', type='float', required=False, defaultValue=0.1, description="Loss of stuff")
def init_parameters():
    pass
