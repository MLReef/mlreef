...
* searchable_type: DATA_PROJECT, ALGORITHM (model in UI), OPERATION and VISUALISATION
...
If you want to filter for an explicit CODE_PROJECT type, use OPERATION, VISUALISATION or ALGORITHM.
