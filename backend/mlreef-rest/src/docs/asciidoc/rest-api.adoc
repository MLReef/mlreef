...
operation::genericprojects-retrieve-public[snippets='curl-request']
...
operation::genericprojects-retrieve-by-slug[snippets='curl-request']

=== GET /projects/namespace/:namespace

operation::genericprojects-retrieve-by-namespace[snippets='curl-request']
...
operation::project-retrieve-users-list-by-namespace-slug[snippets='curl-request']

// @German: please cleanup and re-order these docs :/ it is really messed up... there are chapters.. see line 528 for example
