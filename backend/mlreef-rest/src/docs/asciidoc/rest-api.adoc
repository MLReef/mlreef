...
=== POST /code-projects/environments

Create new environment for publishing code project

operation::create-publish-environment[snippets='curl-request,request-fields,response-body,response-fields']

=== DELETE /code-projects/environments/:id

Delete exiting environment

operation::delete-publish-environment[snippets='curl-request,response-body']
...
Publish current project: pack it to docker and put it to repository
