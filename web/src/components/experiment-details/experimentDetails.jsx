...
const ExperimentDetails = ({ projectId, setNullExperiment, experiment, job, parameters }) => {
    ...
    <>
      ...
      <div style={{display: 'flex'}}>
        <div className="experiment-details-menu">
          ...
          <button id="performance-btn" onClick={menuBtnHandler} className="menu-button">Performance</button>
          <button id="data-btn" onClick={menuBtnHandler} className="menu-button">Data</button>
          <button id="algorithm-btn" onClick={menuBtnHandler} className="menu-button">Algorithm</button>
          <button id="training-btn" onClick={menuBtnHandler} className="menu-button">Training</button>
          <button id="monitoring-btn" onClick={menuBtnHandler} className="menu-button">Monitoring</button>
