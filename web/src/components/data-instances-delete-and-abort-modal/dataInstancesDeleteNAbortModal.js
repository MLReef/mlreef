...
const DataInstanteDeleteModal = ({isModalVisible, setIsVisible, typeOfMessage}) =>
    isModalVisible 
    ? (
        <div>
                    ...
                    <div style={{textAlign: 'center', height: '65%'}}>
                        {typeOfMessage === "delete"
                            ? (<>
                                ...
                                <p>
                                    You will free <b>23 GB</b> of cloud storage.
                                </p>
                                <p>
                            ...
                            : <>
                                ...
                                <p>
                                    <b>
                                        Are you sure you want to abort the creation of the data instance: di_data_pipeline_2
                                    </b>
                                </p>
                                <p>
                                ...
                                <div style={{margin: '0px 3em'}}>
                                    <p style={{textAlign: 'left'}}>Data instance: <b>DI_ProjectName_1</b></p>
                                    <div style={{
